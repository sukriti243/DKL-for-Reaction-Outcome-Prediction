# https://github.com/seokhokang/reaction_yield_nn/blob/main/dataset.py
...
class GraphDataset():
    ...
    def load(self):
        ...
        [rmol_dict, pmol_dict, reaction_dict] = np.load('/homes/ss2971/Documents/GNN-GP/data/dataset_1_0.npz', allow_pickle=True)['data']
