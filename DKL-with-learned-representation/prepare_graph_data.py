# Used from https://github.com/seokhokang/reaction_yield_nn/blob/main/data/get_data.py
...
if __name__ == "__main__":
    ...
    for data_id in [1]:
        for split_id in range(10):
            ...
            load_dict = np.load('/homes/ss2971/Documents/GNN-GP/data/data%d_split_%d.npz' %(data_id, split_id), allow_pickle = True)
            
            rsmi_list = load_dict['data_df'][:,0]
            yld_list = load_dict['data_df'][:,1]
            filename = '/homes/ss2971/Documents/GNN-GP/data/dataset_%d_%d.npz' %(data_id, split_id)
